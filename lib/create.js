...
// 请求 npm 兼容 registry 的包元数据（含 dist-tags.latest）
function fetchRegistryPackageMeta(registry, packageName) {
...
async function promptIfCliOutdated(registry) {
    try {
        const meta = await fetchRegistryPackageMeta(registry, PKG.name)
